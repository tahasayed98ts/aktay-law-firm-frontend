...
const CONTENT_BLOCKS: ContentBlock[] = [
  ...
  { key: 'nav.appointment',           label: 'Navbar → "For Consultation" button',                       section: 'Navbar & Footer' },
  ...
  { key: 'blog.sidebar.consult',      label: 'Blog Detail → Sidebar → "For Consultation" heading',       section: 'Blog Page' },
